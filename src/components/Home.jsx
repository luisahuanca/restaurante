...
export const Home = () => {
    ...
    <div className='container_nosotros p-4'>
        ...
        <div className="row g-0">
          ...
          <div className="col-md-6">
            <div className="card-body">
              ...
              <p className="card-text">Hace 10 años venimos sirviendo los mejores fideos de la ciudad. Aquellos que te reconfortan después de un día cansado,
               ...
               no te resistas a la tentación de disfrutar un rico plato de fideos de tu preferencia! </p>
      ...
      <div className="card mx-auto p-4" style={{width: '50%'}}>
